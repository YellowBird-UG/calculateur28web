...
new Vue({
    ...
    methods: {
        ...
        calculateMbegins: function() {
            //this.calcDate(); is called from calculateFertileBegin
            if (this.cycleSelected === 28) {
                this.menstruationbegins = moment(this.fullDate, 'YYYYMMDD').add(28, 'days').format('MMMM Do YYYY');
            } else {
                this.menstruationbegins = moment(this.fullDate, 'YYYYMMDD').add(this.cycleSelected, 'days').format('MMMM Do YYYY');
            }
        },
        calculateMends: function() {
            //this.calcDate(); is called from calculateFertileBegin
            if (this.cycleSelected === 28) {
                this.menstruationends = moment(this.fullDate, 'YYYYMMDD').add(33, 'days').format('MMMM Do YYYY');
            } else {
                this.menstruationends = moment(this.fullDate, 'YYYYMMDD').add(this.cycleSelected + 5, 'days').format('MMMM Do YYYY');
            }
        },
        calculateOday: function() {
            //this.calcDate(); is called from calculateFertileBegin
            if (this.cycleSelected === 28) {
                this.ovulationday = moment(this.fullDate, 'YYYYMMDD').add(15, 'days').format('MMMM Do YYYY');
            } else {
                this.ovulationday = moment(this.fullDate, 'YYYYMMDD').add(this.cycleSelected - 28 + 15, 'days').format('MMMM Do YYYY');
            }
        },
        ...
        resetCalc: function() {
            ...
            this.dueDate = "";
            this.fullDate = "";
            this.menstruationbegins = "";
            this.menstruationends = "";
            this.ovulationday = "";
        }
    }
});